...
The first step is routing all of these into a single place. We recommend a simple CRM (HubSpot, Notion, or even Airtable) where every lead gets logged with:

- Source (where they came from)
- Initial inquiry (what they said)
- Contact information
- Timestamp
...
- Provide value related to their specific problem
...
- Share social proof
- Offer a clear next step (call, demo, consultation)
- 150-200 words

**Email 4 (7 days later):**
- Gentle check-in
- Offer alternative ways to engage (content, newsletter)
- Leave the door open
- 50-100 words
...
1. **Trigger:** New lead enters your CRM
2. **Action 1:** Send immediate acknowledgment email
3. **Delay:** Wait 24 hours
4. **Action 2:** Send value-add email (using conditional logic based on their inquiry type)
5. **Delay:** Wait 3 days
6. **Action 3:** Send social proof email
7. **Delay:** Wait 7 days
8. **Action 4:** Send final check-in
...
**Reference their specific problem:** If they mentioned "struggling with lead response times," your second email should specifically address that, not send generic automation advice.

**Match their channel:** If they came from LinkedIn, reference that. If from a Facebook group, mention the conversation.

**Conditional content:** Set up your automation so leads interested in "workflow automation" get different content than leads interested in "AI integration."
...
- Leads from enterprise companies → Priority queue
- Leads asking specific technical questions → Technical team outreach
...
- Click rates on CTAs
- Response rates to different emails
...
- Manual follow-up: 1 email per lead
- Lead-to-call rate: 12%

**After automation:**
- Average response time: 3 minutes
- Automated sequence: 4 emails over 7 days
- Lead-to-call rate: 28%
...
1. Pick one lead source (start with your website form)
2. Create a simple 3-email sequence
3. Build the automation with Zapier or Make
4. Test it with 10 leads
5. Measure results, then expand
...
**Want to see how this would work for your specific business?** Book a free 30-minute call and we'll map out exactly what your automated follow-up sequence should look like.
